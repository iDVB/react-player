...
var _SproutVideo = require('./players/SproutVideo');

var _SproutVideo2 = _interopRequireDefault(_SproutVideo);
...
var ReactPlayer = function (_Component) {
  ...
  _createClass(ReactPlayer, [{
    ...
    value: function renderPlayers() {
      ...
      } else if (_SproutVideo2['default'].canPlay(url)) {
        players.push(_SproutVideo2['default']);
      } else if (url) {
